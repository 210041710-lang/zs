...
async def _run_login(account_id: int, profile_path: str) -> None:
    ...
    try:
        ...
        await page.goto("https://www.zhipin.com/web/chat/recommend", wait_until="domcontentloaded")
        ...
        for _ in range(300):
            ...
            try:
                # On Boss Zhipin recruiter backend, after login the URL contains /web/
                # and there should be user info visible
                if "/login" not in url and "/web/" in url:
